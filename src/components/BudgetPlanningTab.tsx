    ...
    <div className="space-y-8 pb-20 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="bg-zinc-900/50 border border-zinc-800 rounded-3xl p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-4 bg-zinc-950 rounded-2xl border border-zinc-800/50">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-emerald-500/10 rounded-lg">
                  <TrendingUp className="w-4 h-4 text-emerald-500" />
                </div>
                <span className="text-sm text-zinc-400">Ожидаемый доход</span>
              </div>
              <span className="text-lg font-bold text-white">{nextMonthPlan.income.toLocaleString()} {baseCurrency}</span>
            </div>
            ...
            <div className="flex justify-between items-center p-4 bg-zinc-950 rounded-2xl border border-zinc-800/50">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-zinc-400">Ожидаемый расход</span>
              </div>
              <span className="text-lg font-bold text-white">{nextMonthPlan.totalExpense.toLocaleString()} {baseCurrency}</span>
            </div>
            ...
            <div className="p-4 bg-zinc-950 rounded-2xl border border-zinc-800/50 space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-xs text-zinc-400">Фиксированные (Подписки/Кредиты)</span>
                  <span className="text-xs font-bold text-zinc-300">{nextMonthPlan.fixedExpense.toLocaleString()} {baseCurrency}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-xs text-zinc-400">Переменные (Лимиты категорий)</span>
                  <span className="text-xs font-bold text-zinc-300">{nextMonthPlan.variableExpense.toLocaleString()} {baseCurrency}</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-3xl p-6 space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-bold text-white">План vs Текущий месяц</span>
                  <span className={cn(
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-bold text-white">План vs Прошлый месяц</span>
                  <span className={cn(
                    "text-xs px-2 py-1 rounded-lg font-bold",
      ...
      <section className="bg-zinc-900/30 border border-zinc-800 p-6 rounded-3xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-sm font-bold text-white">Как улучшить точность планирования?</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            <p className="text-xs font-bold text-zinc-300">1. Регулярные платежи</p>
          ...
          <div className="space-y-2">
            <p className="text-xs font-bold text-zinc-300">2. Реалистичные лимиты</p>
          ...
          <div className="space-y-2">
            <p className="text-xs font-bold text-zinc-300">3. Резервный фонд</p>
